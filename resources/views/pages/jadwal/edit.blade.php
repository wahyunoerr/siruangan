@extends('layouts.dashboard.app', ['title' => 'Edit Jadwal'])

@section('content')
    <div class="page-header">
        <h3 class="fw-bold mb-3">Jadwal Edit</h3>
                        ...
                        <div class="row align-items-center g-4">
                            <div class="col-md-4">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="text" name="hari" id="hari" value="{{ $jadwal->day }}"
...
@section('content')
    <div class="page-header">
        ...
        <ul class="breadcrumbs mb-3">
            ...
            <li class="nav-item">
                <a href="{{ route('jadwal.index') }}">Ruangan</a>
            </li>
            <li class="separator">
                <i class="icon-arrow-right"></i>
            </li>
